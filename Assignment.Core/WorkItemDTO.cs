...
public record WorkItemDetailsDTO(int Id, string Title, DateTime Created, string AssignedToName, IReadOnlyCollection<string> Tags, State State, DateTime StateUpdated);
